...
-- the private keys of certificates and assymetric keys that are
-- present in the database. The master key is encrypted using
-- AES256 and a user supplied passord.
